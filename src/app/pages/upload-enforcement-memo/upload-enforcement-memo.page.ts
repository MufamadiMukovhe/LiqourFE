...
@Component({
  selector: 'app-upload-enforcement-memo',
  templateUrl: './upload-enforcement-memo.page.html',
  styleUrls: ['./upload-enforcement-memo.page.scss'],
})
export class UploadEnforcementMemoPage implements OnInit {
    ...
    outletId: any;
     ...
     submit(): void {
       ...
       formData.append('uploadEnforcementMemo', this.notice);
   
   
     
         this.service.uploadEnforcementMemo(this.caseId, formData).subscribe({
           next: (res: any) => {
             this.spinner.hide();
             console.log(res)
             this.showAlert('success', 'Enforcement Memo Uploaded');
